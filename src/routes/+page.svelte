...
<div class="variant-glass logo-cloud grid-cols-1 gap-1 md:!grid-cols-3 mt-10">
    ...
    <a
        class="logo-item"
        target="_blank"
        href="https://www.linkedin.com/in/vinithalo"
    >
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
    ...
    <a class="logo-item" target="_blank" href="mailto:viniciusit@yahoo.com">
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            class="max-w-10"

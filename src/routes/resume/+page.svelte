...
<section>
    ...
    <ul class="mt-6 list-none">
        ...
        <li>
            <a class="anchor" href="https://www.linkedin.com/in/vinithalo"
                >linkedin.com/in/vinithalo</a
            >
        </li>
        <li>
            <a class="anchor" href="https://viniciusith.cloud"
                >viniciusith.cloud</a
            >
        </li>
    </ul>
...
<section class="mt-12">
    ...
    <article class="my-4 pl-4">
        ...
        <blockquote class="blockquote">
            ...
            <time datetime="2022-01-25T08:00:00.000Z"
            ...
            <p class="mt-4 text-justify">
                ...
                understand their difficulties, which came in hand during the
                pandemic. This was later adapted for mobile use using Capacitor.
                Additionally, I built the API infrastructure using ASP.NET CORE
                to support the application's functionalities.
            </p>
        </blockquote>
    </article>
</section>
...
<section class="mt-12">
    ...
    <article class="my-4 pl-4">
        ...
        <blockquote class="blockquote">
            <h4 class="font-semibold">
                <a href="https://international.unb.br/" class="anchor"
                    >Biotechnology / Computer Science</a
                >
            </h4>
            <time datetime="2023-01-05T08:00:00.000Z"
    ...
    <article class="my-4 pl-4">
        ...
        <blockquote class="blockquote">
            <h4 class="font-semibold">
                High School with Specialization in Information Technology
            </h4>
            <time datetime="2023-01-05T08:00:00.000Z"
                >January, 2020 - December, 2022</time
            >
        </blockquote>
    </article>
</section>
...
<section class="mt-12">
    ...
    <article class="my-4 pl-4">
        ...
        <blockquote class="blockquote">
            <p>
                Typescript, Java, C#, Golang, Python, Web Basics (Html, CSS,
                Javascript)
            </p>
        </blockquote>
    </article>
